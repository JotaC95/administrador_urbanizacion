...
def obtener_vecino_por_nombre_apellido(nombre, apellido):
    cursor.execute(
        "SELECT * FROM vecinos WHERE nombre=? OR apellido=?", (nombre, apellido)
    )
...
def ventana_informacion(id_vecino):
    ...
    tk.Button(
        ventana, text="Editar Pago", command=lambda: editar_pago(id_vecino, tree_info)
    ).grid(row=2, column=1)
...
def editar_pago(id_vecino, tree_info):
...
# Interfaz gráfica
window = tk.Tk()
window.title("Administración de Urbanización")
...
tk.Label(window, text="Número de Lote").grid(row=0, column=0)
entry_numero_lote = tk.Entry(window, textvariable=numero_lote_var)
entry_numero_lote.grid(row=0, column=1)

tk.Label(window, text="Nombre").grid(row=1, column=0)
entry_nombre = tk.Entry(window, textvariable=nombre_var)
entry_nombre.grid(row=1, column=1)

tk.Label(window, text="Apellido").grid(row=2, column=0)
entry_apellido = tk.Entry(window, textvariable=apellido_var)
entry_apellido.grid(row=2, column=1)

tk.Label(window, text="Teléfono").grid(row=3, column=0)
entry_telefono = tk.Entry(window, textvariable=telefono_var)
entry_telefono.grid(row=3, column=1)

tk.Button(window, text="Agregar Vecino", command=agregar_vecino).grid(row=4, column=0)
tk.Button(window, text="Editar Vecino", command=editar_vecino).grid(row=4, column=1)
tk.Button(window, text="Eliminar Vecino", command=eliminar_vecino).grid(row=4, column=2)
...
tk.Button(window, text="Mostrar Información", command=mostrar_informacion_vecino).grid(
